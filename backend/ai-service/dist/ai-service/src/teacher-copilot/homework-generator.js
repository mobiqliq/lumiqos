...
exports.HomeworkGenerator = void 0;
class HomeworkGenerator {
    static generateHomework(subject, topic, count, difficulty) {
        const questions = [];
        for (let i = 0; i < count; i++) {
            ...
            questions.push({
                ...
                difficulty,
                question: 
            } `Generate a \${difficulty} \${type} solving \${topic} contexts dynamically inside \${subject} [Mock Q\${i+1}]\`
             });
        }
        return { questions };
    }
...
exports.HomeworkGenerator = HomeworkGenerator;
//# sourceMappingURL=homework-generator.js.map