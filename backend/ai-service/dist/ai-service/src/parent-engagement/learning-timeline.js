...
exports.LearningTimelineGenerator = void 0;
class LearningTimelineGenerator {
    static translateScore(score) {
        if (score > 0.85)
            return 'excellent';
        if (score > 0.70)
            return 'good';
    ...
    static generate(profile) {
        if (!profile)
            return { error: "No learning profile actively established yet." };
...
exports.LearningTimelineGenerator = LearningTimelineGenerator;
//# sourceMappingURL=learning-timeline.js.map