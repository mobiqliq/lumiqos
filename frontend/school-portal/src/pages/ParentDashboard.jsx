  ...
  return (
    <div>
      <PageHeader
        ...
        subtitle="Your child's academic overview"
        actions={
      ...
      {data && !loading && (
        <>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--sp-4)' }}>
            <div style={card}>
              <h3 style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--text-primary)', marginTop: 0, marginBottom: 16 }}>Attendance Summary</h3>
              {[
            ...
            <div style={card}>
              <h3 style={{ fontSize: 'var(--text-sm)', fontWeight: 600, color: 'var(--text-primary)', marginTop: 0, marginBottom: 16 }}>Fee Status</h3>
              {[
